...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body
        className={`${montserrat.variable} ${playfairDisplay.variable} antialiased min-h-screen bg-[#f6f4f0] text-black font-sans`}
      >
            ...
            <div className="flex justify-between h-20 items-center">
              <Link href="/" className="flex items-center gap-3 group">
                <div className="relative">
                  <div className="w-10 h-10 bg-[#540619] rounded-xl flex items-center justify-center shadow-lg shadow-[#540619]/25 group-hover:shadow-[#540619]/40 transition-all duration-300">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-[#540619] font-medium -mt-0.5">Ottawa</span>
                </div>
              </Link>
