...
import { CreateBusinessDTO, BUSINESS_CATEGORIES } from '@/app/types/business.types';
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="glass rounded-3xl p-8 md:p-10 space-y-6">
          ...
          <p className="text-center text-slate-500 text-sm pt-4">Free to join • No credit card required • Instant listing</p>
        </form>
      </div>
    </div>
  );
