...
const PLACEHOLDER_RESPONSE =
  "Thanks for your message! I'm your onehub assistant. I can help you find local businesses, answer questions about the directory, or point you to events and resources. How can I help you today?";
...
export function ChatAssistant() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm the onehub assistant. Ask me about local businesses, the directory, or how to get started.",
    },
  ]);
      ...
      >
        <div className="flex items-center gap-2 border-b border-slate-200 bg-[#f6f4f0] px-4 py-3">
          ...
          <div className="flex-1">
            <p className="font-semibold text-slate-900">onehub assistant</p>
            <p className="text-xs text-slate-500">AI · Here to help</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="border-t border-slate-200 p-3">
          <div className="flex gap-2">
            <input
              ...
              placeholder="Ask about businesses, events..."
