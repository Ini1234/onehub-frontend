import { Business } from '@/app/types/business.types';
  ...
  if (businesses.length === 0) {
    return (
      <div className="glass rounded-3xl p-16 text-center">
        ...
        <a href="/add" className="inline-flex items-center gap-2 bg-[#540619] text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 hover:bg-[#6d0822] hover:scale-105">
          Add Your Business
