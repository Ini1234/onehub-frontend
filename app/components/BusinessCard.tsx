...
const categoryStyles: Record<BusinessCategory, string> = {
  ...
  Retail: 'bg-blue-500/20 text-blue-700 border-blue-500/30',
  Services: 'bg-emerald-500/20 text-emerald-700 border-emerald-500/30',
  Technology: 'bg-cyan-500/20 text-cyan-700 border-cyan-500/30',
...
export function BusinessCard({ business }: BusinessCardProps) {
  ...
  return (
    <article className="group relative glass rounded-xl overflow-hidden hover:bg-white transition-all duration-300 hover:scale-[1.02] shadow-sm hover:shadow-md">
      <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/20 via-cyan-500/20 to-teal-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10 blur-sm" />
      ...
      <div className="p-3 relative">
        ...
        <div className="space-y-1 text-xs">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <a href={`tel:${business.phone}`} className="text-slate-600 hover:text-cyan-600 transition-colors truncate">
              {business.phone}
            </a>
          </div>
          ...
          {business.website && (
            <div className="flex items-center gap-1.5">
              ...
              <a href={business.website} target="_blank" rel="noopener noreferrer" className="text-cyan-600 hover:text-cyan-700 transition-colors truncate">
                Website
              </a>
            </div>
          )}
